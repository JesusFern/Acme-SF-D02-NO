...
@Service
public class EmployerApplicationUpdateService extends AbstractService<Employer, Application> {
	...
	public void authorise() {
		...
		status = application != null && //
			...
			super.getRequest().getPrincipal().hasRole(application.getJob().getEmployer());
