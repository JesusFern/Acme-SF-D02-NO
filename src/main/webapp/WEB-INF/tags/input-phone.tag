...
<jstl:if test="${placeholder == null}">
	<jstl:set var="placeholder" value="default.placeholder.phone"/>	
</jstl:if>
...
<div class="form-group">
	...
	<acme:show-errors path="${path}.countryCode"/>
	<acme:show-errors path="${path}.areaCode"/>
	<acme:show-errors path="${path}.number"/>
</div>
